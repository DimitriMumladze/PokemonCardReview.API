...
using PokemonCardReview.DTO;
using PokemonCardReview.Interfaces;
using PokemonCardReview.Models;
using PokemonCardReview.Repository;

namespace PokemonCardReview.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public IActionResult GetReview(int reviewsId)
        {
            if(!_reviewRepository.ReviewExists(reviewsId))
                return NotFound();

            var review = _mapper.Map<ReviewDto>(_reviewRepository.GetReview(reviewsId));
